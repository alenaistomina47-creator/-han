...
const appData = {
    ...
    stoves: [
        { id: 'stand', name: 'Подставка (без печи)', price: 9200, image: 'https://i.1.creatium.io/disk2/77/b3/d8/353e905bc23d7489b1d1399842f5a7c48f/podstavka_result.webp', zIndex: 5 },
        { id: 'wind', name: 'Ветрозащита', price: 25300, image: 'https://i.1.creatium.io/disk2/09/8e/c1/538b956b9f526cf7bf80898a5d815bbfd6/vindgard_result.webp', zIndex: 5 },
        { id: 'simple', name: 'Печь-подставка', price: 37950, image: 'https://i.1.creatium.io/disk2/b4/31/61/bd99e3a713ad36d9d5f537b0e90c447853/pech_podstavka_result.webp', zIndex: 5 },
        ...
        { id: 'welded_304', name: 'Печь приварная (AISI 304)', price: 65000, image: 'https://i.1.creatium.io/disk2/89/f1/c6/e8339e162a5e77541df28eab6fae9bafa7/vodyanaya_result.webp', zIndex: 5 },
        { id: 'jacket', name: 'С водяной рубашкой', price: 95450, image: 'https://i.1.creatium.io/disk2/89/f1/c6/e8339e162a5e77541df28eab6fae9bafa7/vodyanaya_result.webp', zIndex: 5 }
    ],
    finishes: [
        { id: 'min', name: 'Минимум', price: { small: 18400, medium: 18400, large: 23000 }, image: 'https://i.1.creatium.io/disk2/89/cd/95/30c96399ab24a35874c4c9e5efd305795e/otdelka_minimum_result.webp', imageInside: 'https://i.1.creatium.io/disk2/02/13/08/5bb366dcaccb9f7066864ab224e360185d/vverh_minimum_result.webp', zIndex: 15 },
        { id: 'std', name: 'Стандарт', price: { small: 26450, medium: 26450, large: 32200 }, image: 'https://i.1.creatium.io/disk2/32/79/90/04cabe0cc0e3be78c1814fe5e723453d6e/otdelka_srednyaya_result.webp', imageInside: 'https://i.1.creatium.io/disk2/36/8e/c4/8d2b3383f58194b2ab6e7cd033b6e6b692/vverh_standart_result.webp', zIndex: 15 },
        { id: 'max', name: 'Максимум', price: { small: 37950, medium: 37950, large: 48300 }, image: 'https://i.1.creatium.io/disk2/42/ae/47/8124e9442d699a01dc439962ec3f1d0607/otdelka_maksimum_result.webp', imageInside: 'https://i.1.creatium.io/disk2/96/9b/f4/4a0fa0db35a35941ca508020dcc87f286e/vverh_maksimum_result.webp', zIndex: 15 }
    ],
    extras: [
        ...
        { id: 'table_central', name: 'Центральный столик', price: 8050, image: 'https://i.1.creatium.io/disk2/6b/d4/03/5e1b82338f81a1b2c22242bb7fc37cd769/centralniy_stolik_result.webp', imageInside: 'https://i.1.creatium.io/disk2/f2/b6/68/10684600f9e1b967af7c35a737abac03a2/vverh_stol_centr_result.webp', zIndex: 35 },
        ...
        { id: 'light', name: 'Подсветка (LED)', price: 34500, image: 'https://i.1.creatium.io/disk2/f3/31/b1/f5f7dc8367bd44671c007465af094546ff/effekt_osveshennosti_result.webp', zIndex: 40 },
